...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Внедрение системы стоит 100 000 ₸ (единоразово). Со второго месяца — 49 000 ₸/мес за использование. Для сравнения: таргетолог стоит от 200 000 ₸/мес + агентство. Экономия составляет до 150 000 ₸ каждый месяц.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "ИИ-Таргетолог окупается за первый месяц. Вы платите 100 000 ₸ за внедрение + 49 000 ₸/мес, вместо 200 000+ ₸/мес таргетологу. Экономия начинается с первого дня, а автоматическая оптимизация часто снижает стоимость заявки на 20-40%.",
  },
  {
