...
export const metadata: Metadata = {
  ...
  keywords:
    "AI чат-бот, Telegram бот, WhatsApp бот, Instagram бот, автоматизация заявок, чат-бот для бизнеса, Алматы",
  openGraph: {
    title: "AI-чат-боты для бизнеса — AOne Agency",
    description:
      "Умные боты для Telegram, WhatsApp, Instagram. Обработка заявок 24/7, интеграция с CRM от 150 000 ₸",
    locale: "ru_RU",
  },
};
      ...
      <article className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <header className="py-12 mb-16">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8 max-w-3xl">
            Умные боты для Telegram, WhatsApp, Instagram. Обработка заявок 24/7, интеграция с CRM,
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-700 mb-4 leading-relaxed">
                <strong>AI-чат-бот</strong> — это умный виртуальный помощник, который автоматически
                общается с вашими клиентами в мессенджерах (Telegram, WhatsApp, Instagram).
              </p>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Бот работает 24/7, мгновенно отвечает на вопросы, принимает заявки, консультирует по
                товарам и услугам, записывает на встречи — всё без участия менеджера.
              </p>
              <p className="text-gray-700 leading-relaxed">
                С помощью искусственного интеллекта бот понимает естественный язык (русский,
                казахский, английский), распознает намерения клиента и предлагает релевантные
                решения.
              </p>
            </div>
        ...
        <section className="mb-16 bg-gray-50 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-700">
                Квалификация лидов, запись на встречи, отправка коммерческих предложений,
                CRM-интеграция.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6">
            ...
            {[
              {
                ...
                description:
                  "Изучаем ваш бизнес, целевую аудиторию, частые вопросы клиентов. Определяем функционал бота и KPI.",
                duration: "1-2 дня",
              },
              {
                step: 2,
                ...
                description:
                  "Создаём сценарии общения (скрипты), структуру меню, логику ответов на вопросы. Согласовываем с вами.",
                duration: "2-3 дня",
              },
              {
                step: 3,
                ...
                description:
                  "Программируем бота, обучаем нейросеть на ваших данных, настраиваем распознавание естественного языка.",
                duration: "5-7 дней",
              },
              {
                step: 4,
                ...
                description:
                  "Подключаем бота к amoCRM/Bitrix24, платёжным системам, базам данных, другим инструментам.",
                duration: "2-3 дня",
              },
              {
                step: 5,
                ...
                description:
                  "Проверяем все сценарии, исправляем ошибки, обучаем вашу команду работе с ботом. Запускаем в продакшн.",
                duration: "1-2 дня",
              },
            ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6">
                Каталог из 500+ товаров, корзина, оплата, отслеживание заказа. Бот обрабатывает 200+
                заказов в день без участия менеджера.
              </p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6">
                Онлайн-запись к мастерам, напоминания о визитах, отзывы, программа лояльности.
                Интеграция с amoCRM.
              </p>
              <div className="space-y-2">
                <p className="text-sm text-gray-600">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Разработка умных чат-ботов для Telegram, WhatsApp, Instagram. Автоматизация обработки заявок 24/7.",
            provider: {
              "@type": "Organization",
              name: "AOne Agency",
