        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-label mb-4">
              ...
              графику, дизайн и программный код, являются собственностью AOne Agency или наших
              партнеров и защищены законами об интеллектуальной собственности.
            </p>
            <p className="text-label mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-label mb-4">
              AOne Agency не несет ответственности за:
            </p>
            <ul className="text-label mb-4 list-disc pl-6">
            ...
            <p className="text-label mb-4">
              Мы прилагаем все усилия для обеспечения стабильной работы Сайта, но не гарантируем
          ...
          <section className="mb-8">
            ...
            <p className="text-label mb-4">
              Наш Сайт может содержать ссылки на сторонние веб-сайты. Мы не контролируем и не
              несем ответственности за содержание, политику конфиденциальности или практики этих
              сайтов.
            </p>
          </section>
